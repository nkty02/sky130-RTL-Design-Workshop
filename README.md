...
![image](https://user-images.githubusercontent.com/75198926/166295071-f899443b-e8e6-4799-97c8-0bfa958eafcc.png)



**Bad coding style which results in inferred latches**

![image](https://user-images.githubusercontent.com/75198926/166295687-10b2bb9b-e7f9-403e-af7e-3ad9d62d1966.png)



## Lab on incomplete IF Case

In this session we will see examples which demonstrates the problems caused by incomplete IF statements.
...
- **The following figure depicts the RTL design of our first combinational circuit constructed using IF statements :** 
...
- **The following figure depicts the RTL design of our second combinational circuit constructed using IF statements :** 
...
In this session we will see examples which demonstrates the problems caused by overlapping and missing case conditions.
...
- **The following figure depicts the RTL design of our first combinational circuit constructed using case statements :** 

![image](https://user-images.githubusercontent.com/75198926/166297484-1f9f1378-1e2e-4f80-b7fc-112bad45a765.png)
...
- **The following figure depicts the RTL design of our second combinational circuit constructed using case statements :** 
...
- **The following figure depicts the RTL design of our third combinational circuit constructed using case statements :** 
...
- **The following figure depicts the RTL design of our forth combinational circuit constructed using case statements :** 
...
As we can see the output is latching to value 1 due to overlapping case conditions. This waveform is from RTL simulation.
...
As we can see the output is not latching to value 1 even though there are overlapping case conditions. This is because the synthesizer is capable to assign different case conditions if there are any overlapping case conditions.


## Labs on For loop and For Generate

In this session we will see examples which demonstrates how to use for construct for looping and for generate condition for replication os hardware.
...
- **The following figure depicts the RTL design of our first combinational circuit constructed using for construct :** 
...
- **The following figure depicts the RTL design of our second combinational circuit constructed using for construct :** 
...
- **The following figure depicts the RTL design of our third combinational circuit constructed using for construct :** 
...
- **The following figure depicts the RTL design of rca combinational circuit constructed using for generate construct :** 

![image](https://user-images.githubusercontent.com/75198926/166160898-47876349-1850-4a55-b749-bb486dacd3fd.png)


- **The following figure depicts the RTL design of fa combinational circuit :** 

![image](https://user-images.githubusercontent.com/75198926/166160973-257fa740-ebba-4d90-b2c7-8d2d06bd6260.png)


- **The waveforms generated by gtkwave of the simulated design using RTL simulation are as follows :** 
...
- **The logical part of the synthesized netlist(rca) is as follows :**

![image](https://user-images.githubusercontent.com/75198926/166161694-b8eadb9e-0c24-4929-8c96-bc78a60d9d87.png)


- **The logical part of the synthesized netlist(fa) is as follows :**
