...
- **posedge of reset :** Here the clock goes from 0 to 1 i.e., reset is applied so as soon as the reset goes to 1 our output q went to 0 immediately without waiting for next posedge of the clock. 

![image](https://user-images.githubusercontent.com/75198926/166105179-a184f4d6-2fb1-48a5-8a8f-2aa7391fd3c8.png)

- **negedge of reset :** Here the clock goes from 1 to 0 i.e., reset is switched off so as soon as the reset goes to 0 our output q remained at 0 waiting for next posedge of the clock and when next posedge occured then d followed q untill next posedge.
